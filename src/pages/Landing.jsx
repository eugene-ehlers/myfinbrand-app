...
const Pillar = ({ icon: Icon, title, text }) => (
  <div className="p-6 rounded-2xl border bg-white/80 backdrop-blur shadow-sm hover:shadow-md transition-shadow">
    <div className="flex items-start gap-4">
      <div className="p-2 rounded-xl" style={{ background: "rgba(43,212,224,0.08)", border: "1px solid rgba(43,212,224,0.18)" }}>
    ...
    <header className="site-header">
      <div className="page-container flex items-center justify-between py-3">
        <Link to="/" className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-md" style={{ background: "linear-gradient(135deg, rgba(2,6,23,.9) 0%, rgba(43,212,224,.35) 100%)" }} />
      ...
      <header className="relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            ...
            style={{ background: "radial-gradient(60% 60% at 50% 50%, rgba(43,212,224,0.35) 0%, rgba(43,212,224,0.0) 70%)" }}
          />
        </div>
            ...
            >
              <div className="md:col-span-7">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full"
                     style={{ background: "rgba(43,212,224,0.12)", border: "1px solid rgba(43,212,224,0.30)" }}>
                ...
                <div className="mt-8 flex flex-wrap items-center gap-3">
                  ...
                  <a
                    ...
                    style={{ background: "rgba(252,250,247,0.08)", borderColor: "rgba(255,255,255,0.35)", color: "rgb(var(--cream))" }}
                  >
                ...
                <div className="relative">
                  <div className="rounded-3xl border bg-white/95 shadow-sm p-6">
                    <div className="grid grid-cols-2 gap-4">
                      <div className="p-4 rounded-2xl border" style={{ background: "rgb(var(--surface))" }}>
      ...
      <Section className="py-10 md:py-14">
        <div className="grid items-center gap-6 md:grid-cols-12">
          <div className="md:col-span-4">
            ...
            <p className="mt-2 text-slate-700">We partner with executives in finance, retail, logistics, telecoms, insurance, and the public sector to turn data into competitive advantage.</p>
          </div>

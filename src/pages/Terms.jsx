  ...
  return (
    ...
    >
      <Seo
        ...
        description="Terms of use for The Smart Decision Group website."
      ...
      <main className="page-container mx-auto max-w-3xl px-4 pt-10 pb-16">
        ...
        <p className="mt-3 text-slate-700 leading-relaxed">
          This is a placeholder terms-of-use page. Replace with final terms covering:
          permitted use, intellectual property, limitation of liability, and website
          availability.
        </p>

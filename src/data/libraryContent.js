    ...
    sections: [
      {
        ...
        paragraphs: [
          "Many well-run businesses still rely on people, judgement, spreadsheets, and simple systems to make important decisions.",
          "This is not a flaw. It is often a sign of experience, proximity to the work, and a business that has grown through understanding rather than abstraction.",
          "Being manual does not mean being naïve, unsophisticated, or exposed.",
        ],
      },
      {
        heading: "Why this library exists",
        paragraphs: [
          "This library exists to help operators think clearly about decisions — before anything feels urgent.",
          "It is not training material. It is not a maturity model. It is not a roadmap that assumes an endpoint.",
          "It is a place to reflect on how decisions are made today, what they cost in effort, and whether they still fit the business you are trying to run.",
        ],
      },
      {
        heading: "What this is not asking you to do",
        paragraphs: [
          "This is not asking you to automate.",
          "It is not asking you to adopt new systems, models, or technology.",
          "It is not suggesting that progress is inherently better than staying where you are.",
          "Many organisations remain manual by choice — and do so well.",
        ],
      },
      {
        heading: "The real question underneath most decision problems",
        paragraphs: [
          "Most decision challenges are not caused by a lack of tools.",
          "They are caused by a lack of clarity.",
          "When decisions work, people rarely ask how they work. When they stop working, it becomes surprisingly difficult to explain what changed.",
        ],
      },
      {
        heading: "Why decisions feel harder as businesses change",
        paragraphs: [
          "As businesses grow, diversify, or face new pressure, the context around decisions shifts.",
          "Volumes increase. New staff join. Repeat customers behave differently. Costs matter more. Regulators and partners ask sharper questions.",
          "The same decision approach that worked before may still function — but it requires more effort to maintain.",
        ],
      },
      {
        heading: "Effort is often the first signal",
        paragraphs: [
          "One of the earliest signs that fit is drifting is rising effort.",
          "More reviews. More explanations. More senior involvement. More exceptions.",
          "Results may remain acceptable, but they are achieved through increasing work rather than clarity.",
        ],
      },
      {
        heading: "Why ‘good enough’ is a valid destination",
        paragraphs: [
          "There is no universal end state for decisioning.",
          "For some businesses, ‘good enough’ means remaining manual, close to customers, and flexible.",
          "For others, it means clarifying and stabilising certain decisions to reduce cost, improve fairness, or support growth.",
          "Neither path is better or worse. What matters is alignment.",
        ],
      },
      {
        heading: "Progress does not have to be dramatic",
        paragraphs: [
          "Progress is often imagined as a large, irreversible step.",
          "In practice, it is usually incremental: writing down rules that already exist, separating policy from process, clarifying who owns which decisions, or learning cleanly from changes.",
          "Many organisations improve control without introducing new technology at all.",
        ],
      },
      {
        heading: "The danger of drifting instead of choosing",
        paragraphs: [
          "Problems tend to arise not when a business stays manual, but when it drifts.",
          "Rules change without clear intent. Responsibility moves without being acknowledged. Effort compensates for ambiguity.",
          "Over time, control erodes quietly — even though nothing obvious breaks.",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "Start with situations that feel familiar. Sit with questions that feel uncomfortable. Read field notes that resonate.",
          "There is no required sequence and no required outcome.",
        ],
      },
      {
        heading: "A grounding perspective",
        paragraphs: [
          "If the way you make decisions today supports your business, your ambitions, and your peace of mind, there may be no reason to change.",
          "If it works but feels increasingly heavy, fragile, or hard to explain, that awareness is valuable in itself.",
          "This library exists to help you recognise that moment — calmly, without pressure.",
        ],
      },
      {
        ...
        paragraphs: [
          "You are not late.",
          "You are not expected to ‘catch up’.",
          "You are simply being invited to understand your decisions well enough to protect what you have built — and to choose deliberately if and when change makes sense.",
        ],
      },
    ],
  },
